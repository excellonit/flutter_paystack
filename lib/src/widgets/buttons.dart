...
class AccentButton extends StatelessWidget {
  ...
  AccentButton({Key? key, required this.onPressed, required this.text, this.showProgress = false})
    : super(key: key);
...
class _BaseButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var textWidget;
    if (text != null) {
      textWidget = new Text(text!, textAlign: TextAlign.center, style: textStyle);
    }
        ...
        child: new TextButton(
          ...
          child: showProgress
              ? new Container(
                  width: 20.0,
                  height: 20.0,
                  child: new CircularProgressIndicator(strokeWidth: 2.0, color: Colors.white),
                )
              : iconData == null
              ? child == null
                    ? textWidget
              ...
              : new Row(
                  ...
                  children: <Widget>[
                    new Icon(iconData, color: textStyle.color!.withValues(alpha: 0.5)),
